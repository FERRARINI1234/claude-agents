...
AgentSpec 1 adds Agent Matching (Design phase) and Agent Delegation (Build phase):
...
| ------- | ---- | ------- |
| 1.0.0 | 2026-02-11 | Criated initial AgentSpec 1 workflow contract with 5-phase structure |